...
export default function getRandomDogBreed() {
  const dogBreedsArray = dogBreeds.split("\n");
  const randomDogBreed =
    dogBreedsArray[Math.floor(Math.random() * dogBreedsArray.length)];
